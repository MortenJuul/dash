...
for row in rows:
    values.append("(" + ", ".join([
        ...
        sql_num(get(row, 'subcutaneous_fat_pct')),
        sql_num(get(row, 'visceral_fat')),
        sql_num(get(row, 'skeletal_muscle_pct')),
        sql_num(get(row, 'muscle_mass_kg')),
        sql_num(get(row, 'fat_free_body_weight_kg')),
        sql_num(get(row, 'body_water_pct')),
        sql_num(get(row, 'bone_mass_kg')),
        sql_num(get(row, 'protein_pct')),
        sql_int(get(row, 'bmr_kcal')),
        sql_int(get(row, 'metabolic_age')),
...
insert into challenge.forge_daily (
  ...
  bmi, body_fat_pct, subcutaneous_fat_pct, visceral_fat, skeletal_muscle_pct,
  muscle_mass_kg, fat_free_body_weight_kg, body_water_pct, bone_mass_kg,
